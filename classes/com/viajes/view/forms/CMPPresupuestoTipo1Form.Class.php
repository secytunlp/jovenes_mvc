...
/**
 * Formulario para presupuesto tipo 1 de solicitud
 *  
 * @author Marcos
 * @since 05-05-2014
 */
class CMPPresupuestoTipo1Form extends CMPForm{
	 ...
	 */
	public function __construct($action="add_presupuesto_tipo1_session",$id="edit_presupuesto_tipo1") {
		...
		$this->setOnSuccessCallback("add_presupuesto_tipo1");
		$this->setBeforeSubmit("before_submit_presupuesto_tipo1");
		

		$fieldset = new FormFieldset( $this->getLegend() );
		
		
		$fieldset->addField( FieldBuilder::buildFieldDate ( CYT_LBL_PRESUPUESTO_DATE, "dt_fecha_tipo1", CYT_MSG_PRESUPUESTO_FECHA_REQUIRED) );
