 ...
 * @since 30-04-2014
 */
class CMPJovenesProyectoForm extends CMPForm{
	 ...
	 */
	public function __construct($action="add_jovenesProyecto_session",$id="edit_jovenesProyecto") {
		...
		$this->setOnSuccessCallback("add_jovenesProyecto");
		$this->setBeforeSubmit("before_submit_jovenesProyecto");
